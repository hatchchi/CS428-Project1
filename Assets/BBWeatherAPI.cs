...
public class BBWeatherAPI : MonoBehaviour
{
    public GameObject weatherTextObject;
    // add your personal API key after APPID= and before &units=
    string url = "https://api.openweathermap.org/data/2.5/weather?lat=52.51&lon=-13.37&APPID=6206917e449d6342acb9f696ee842105&&units=metric";
